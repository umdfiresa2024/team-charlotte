...
plot(x)
pm_sources <- vect("pm_sources.shp")
plot(pm_sources)
...
plot(x)
points(pm_sources, col="yellow", pch=17, cex=0.5)

# pch=19 gives filled circles
points(x, col="blue", pch=19, cex=0.2)
...
```{r}
writeVector(pts_buffer, "buffer_light_rail.shp")
```
