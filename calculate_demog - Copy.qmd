...
#leaving out parking as a factor, but its still being included in the regression stuff?
```
...
race<-get_decennial(geography = "block", variables=targetvars, state="NC", county="Mecklenburg", output="wide", year = 2010)
